<x-app>
    ...
    <div class="card shadow p-3">
        <form method="POST" action="{{ route('user.update', $user->id) }}" class="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <div class="mt-2">
                        <img src="{{ $user->avatar ? asset('storage/' . $user->avatar) : asset('niceadmin/img/noprofil.png') }}"
                            alt="Avatar" class="rounded border shadow-sm"
                            style="width: 150px; height: 150px; object-fit: cover;" id="preview">
                    </div>
                </div>
            </div>
            <div class="text-end">
